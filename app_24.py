...
class MainWindow(QMainWindow):
    ...
    def CreateActions(self):
        ...
        self.openAction = QAction(QIcon('iconos/open.png'), 'O&pen', self,
                                  shortcut=QKeySequence.Open,
                                  statusTip="Open an existing file",
                                  triggered=self.openFile)
        self.saveAction = QAction(QIcon('iconos/save.png'), '&Save', self,
        ...
        self.cutAction = QAction(QIcon('iconos/cut.png'), 'C&ut', self,
        ...
        self.selectAllAction = QAction(QIcon('iconos/selectAll.png'), 'Select All',
                                       self, statusTip="Select All",
                                       triggered=self.textEdit.selectAll)
        self.redoAction = QAction(QIcon('iconos/redo.png'),'Redo', self,
                                  shortcut=QKeySequence.Redo,
                                  statusTip="Redo previous action",
                                  triggered=self.textEdit.redo)
        self.undoAction = QAction(QIcon('iconos/undo.png'),'Undo', self,
